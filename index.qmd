...
![](SCORE_logo.png){fig-alt="SCORE network logo" width=50%}
...
-	**Ironman module**
    ...
    -	Break into small groups and work through [handout](https://github.com/iramler/uscots2023_score/tree/master/modules/triathlon_womens_ironman){target="_blank"}
...
-	Other modules:  Break into groups based on interest
    ...
    - Downloadable (from GitHub) partial modules
        -	[Lacrosse: PLL vs NLL](https://github.com/iramler/uscots2023_score/tree/master/modules/lacrosse_pll_vs_nll){target="_blank"}: Difference in means
        -	[League of Legends](https://github.com/iramler/uscots2023_score/tree/master/modules/league_of_legends){target="_blank"}: Outlier detection
        -	[PGA](https://github.com/iramler/uscots2023_score/tree/master/modules/pga_drive_putt){target="_blank"}: Correlations
            - No/low tech version
            - Statistical Software required (e.g., Minitab, SPSS, R, etc.)
        - [NCAA Div I Softball](https://github.com/iramler/uscots2023_score/tree/master/modules/softball_div1){target="_blank"}: Joining/Merging Data Tables
